...
const CartPage = () => {
  ...
  const handleQuantityChange = async (productId, newQuantity) => {
    try {
      ...
      const response = await fetch("https://salessavvy-backend-c2yc.onrender.com/api/cart/update", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const handleCheckout = async () => {
    try {
      ...
      const response = await fetch("https://salessavvy-backend-c2yc.onrender.com/api/payment/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            const verifyResponse = await fetch("https://salessavvy-backend-c2yc.onrender.com/api/payment/verify", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              credentials: "include",
              body: JSON.stringify({
